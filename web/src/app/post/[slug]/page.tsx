  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="mx-auto max-w-4xl px-6 py-12">
        <div className="article-page-wrapper rounded-3xl p-6 shadow-sm md:p-8">
        <Link
          href="/"
      ...
      {post.mainImage?.asset?.url && (
        <figure className="article-card group relative mt-8 overflow-hidden rounded-2xl border transition-transform duration-300 hover:scale-[1.01]">
          ...
          {post.imageCaption && <figcaption className="px-5 pb-4 pt-3 text-sm text-muted-foreground">{post.imageCaption}</figcaption>}
        </figure>
      )}
        ...
        {useSections ? (
          <section className="mt-10 space-y-10">
            ...
            {sections.map((section) => (
              <article
                id={section.id}
                key={section.id}
                className="article-card rounded-2xl border p-6 shadow-sm"
              >
          ...
          <article className="article-card mt-10 rounded-2xl border p-6 shadow-sm">
